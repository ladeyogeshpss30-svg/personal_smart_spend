🔐 Privacy Policy – Personal Smart Spend

Effective Date: 9 January 2026

Personal Smart Spend (“we”, “our”, “us”) respects your privacy and is committed to protecting your personal and financial information. This Privacy Policy explains how Personal Smart Spend collects, uses, and safeguards information when you use the application.
...
All financial and personal data you enter into Personal Smart Spend, including:

Income and expense records

Categories and notes

Budgets, goals, and savings data
...
If you choose to use the backup feature, backup files are created locally and saved only to the location you select (such as your device storage or personal cloud drive). We do not access, store, transmit, or manage your backup files.

Optional encryption may be available to help protect backup files.

6. App Permissions

Personal Smart Spend may request certain device permissions only to provide core features, including:

Storage access – to create or restore backup files

Biometric or device security – to enable app lock and authentication

Notifications – to deliver reminders and alerts

Permissions are used strictly to support app functionality.
...
Optional app lock and biometric protection
